...
<body>
        ...
        <div class="row">
            ...
            <br />
            <div align="right">
                <button type="button" name="create_record" id="create_record" class="btn btn-success text-dark"> <i class="bi bi-plus-square"></i> Add</button>
            </div>
            <br />
                <table class="table table-red-700 table-striped table-bordered user_datatable"> 
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Name</th>
